...
const Hero = () => {
    ...
    // set the scrollbar to hidden before fonts load
    gsap.set("body", { overflow: "hidden" });
        
    // split header text into chars and words
    ...
    // add gradient text class to each word in header
    ...
    delay: 2,
        ...
        // set the scrollbar to auto after animations complete
        gsap.to("body", { overflowY: "auto", overflowX: "hidden", });
